...
venue: "miami"        # brief name of host site without address (e.g., "Euphoric State University")
address: "151 s campus ave"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
